...
function Home() {
  ...
  return (
    <div>
      ...
      <div>
        <section id="home">
          <h2>Enhance your future with E-Learning-Hub</h2>
          <p>
            {" "}
            OneYes Learning is a massive open online course provider, and its
        ...
        <section id="course">
          ...
          <p>10,000+ enrolled</p>
          <a className="blueline" href="/courses">
